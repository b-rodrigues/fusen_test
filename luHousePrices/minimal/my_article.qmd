...
#' This function lists the needed dependencies
#'
...
define_imports <- function(){
  message("Why you calling me?")
}
```
...
usethis::use_pipe()
fusen::inflate(flat_file = "minimal/my_article.qmd", vignette_name = "Data cleaning")
```
